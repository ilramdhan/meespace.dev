                    ...
                    <div className="p-8 overflow-y-auto custom-scrollbar">
                        <form className="space-y-6">
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="job-title"
                                        type="text"
                                        defaultValue="Senior Business Systems Analyst"
                                    />
                                </div>
                                <div>
                                    <label
                            ...
                            <div className="flex items-center gap-3">
                                <input type="checkbox" id="current-role" className="rounded border-gray-300 text-sage-green focus:ring-sage-green bg-white dark:bg-black/20 dark:border-gray-600 size-4 cursor-pointer" defaultChecked />
                                <label htmlFor="current-role" className="text-sm text-text-main dark:text-white font-medium cursor-pointer">I currently work here</label>
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="location"
                                    type="text"
                                    defaultValue="San Francisco, CA (Hybrid)"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    id="description"
                                    rows={4}
                                    defaultValue="Leading the migration of legacy ERP systems to cloud-based solutions, conducting stakeholder interviews, and defining system requirements for cross-functional teams."
                                ></textarea>
                            </div>
                        </form>
                    </div>
